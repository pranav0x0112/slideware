...
\begin{frame}{Memory Organization in SDRAM}
    ...
    \vspace{0.3cm}
    \centering
    \includegraphics[width=0.4\textwidth]{images/sdram_addressing.png}
\end{frame}

%------------------------------------------------
% Slide 9: Why Banks, Rows, and Columns?
%------------------------------------------------
...
\begin{frame}{SDR (Single Data Rate)}
    \begin{itemize}
        ...
        \item Memory bandwidth is directly limited by clock frequency
        \item Row and column commands are synchronized to the clock
    \end{itemize}

    \vspace{0.3cm}
    \centering
    \includegraphics[width=0.7\textwidth]{images/sdr_timing.png}
\end{frame}

%------------------------------------------------
% Slide 11: SDR Key Operations
%------------------------------------------------
\begin{frame}{SDR Key Operations}
    \begin{itemize}
        \item RAS command activates a row in the selected bank
        \item Activated row data is latched into sense amplifiers
        \item Column READ or WRITE accesses data from sense amplifiers
        \item Precharge closes the row before another row can be activated
    \end{itemize}

    \vspace{0.3cm}
    \centering
    \includegraphics[height=0.5\textheight]{images/sdr_operations.png}
\end{frame}

%------------------------------------------------
% Slide 12: SDR Timing Parameters and Commands
%------------------------------------------------
