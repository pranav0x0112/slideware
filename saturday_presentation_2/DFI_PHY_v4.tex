...
\begin{column}{0.62\textwidth}
  \centering
  \begin{tikzpicture}
    %% Timeline axis — total width ~10cm fits in 0.62\textwidth
    \draw[-{Stealth[length=5pt]},thick,ddrgray] (-0.4,0) -- (9.5,0)
    ...
    %% Feature table
    \node[font=\fontsize{5pt}{6pt}\selectfont,align=center,ddrgray] at (4.0,-1.5) {%
...
\begin{column}{0.3\textwidth}
  \vspace{8pt}
  \textbf{\color{ddrblue}Off-Die (Picoseconds)}
  ...
  \end{itemize}
  \vspace{10pt}
  \textbf{\color{ddrteal}On-Die (Femto/Attoseconds)}
  \begin{itemize}\setlength\itemsep{6pt}
  ...
  \end{itemize}
  \vspace{10pt}
  \textit{PCB/package is the timing bottleneck, not the silicon.}
\end{column}
...
\begin{column}{0.48\textwidth}
  ...
  \begin{itemize}\setlength\itemsep{8pt}
    ...
    \item Adopted by ARM, Synopsys, Cadence PHY IP
  \end{itemize}
\end{column}
